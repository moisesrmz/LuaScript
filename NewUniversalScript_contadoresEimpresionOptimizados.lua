...
-- Secuencia para nombres PRN únicos
--local _prn_seq = 0

-- Asegura que exista el directorio de trabajo de impresiones
local function _ensure_dir(path)
    -- mkdir no falla si ya existe
...
-- Ejecuta un comando en *verdadero* oculto mediante un lanzador .vbs temporal
--   cmdline: comando completo que quieras ejecutar
--   log_on_error: si true, registra en exec.log si falla


-- Lanza un .vbs SIN ventana y con timeout real (mata cscript si se pasa)
--   vb_path: ruta del .vbs
--   args: argumentos (string, opcional)
--   timeout_sec: segundos (default 5)


-- Copia el PRN al share/puerto de la impresora SIN consola, con 1 retry y log en error
...
---------------------------------------------------------------------------------------------------------------------------------------------     
    ...
    elseif sPartNumber == "2003020692" then
        sRev = "REV A"
        sNp = "74751006"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z120-C00-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z120-C00-C2.vbs")
    elseif sPartNumber == "2003020696" then
        sRev = "NRS-S-DVP2052"
        sNp = "Hybrid Jack-SF Plug"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z117-C01-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
    elseif sPartNumber == "2088701244" then
        sRev = "REV B1"
        sNp = "09922944"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-A.vbs")
    elseif sPartNumber == "2088701390" then
        sRev = "REV A1"
        sNp = "09923074"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-L.vbs")
    ...
    elseif sPartNumber == "2088702221" then
        sRev = "REV A1"
        sNp = "284R4 7SB0C"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ025-000-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-A.vbs")
    ---------------------------------------------------------Nissan--------------------------------------------------
    elseif sPartNumber == "2088702198" then
        sRev = "REV B1"
        sNp = "284T6 7SA0C"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ010-C00-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-F.vbs") 
    elseif sPartNumber == "2088702199" then
        sRev = "REV C"
        sNp = "284T6 7SA0D"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW01-000-F.vbs")
    elseif sPartNumber == "2088702200" then
        sRev = "REV C"
        sNp = "284R5 7SB0B"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-N.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ032-C00-B.vbs")
    elseif sPartNumber == "2088702207" then
        sRev = "REV C"
        sNp = "284R4 7SA0B"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW31-000-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ010-C00-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW01-000-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ025-000-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-N.vbs")
    ...
    elseif sPartNumber == "2088702318" then
        sRev = "REV A"
        sNp = "284R2 7SA1D"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-E.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMK18A-102Z5.vbs")
    ...
    elseif sPartNumber == "2098700083" then
        sRev = "REV A1"
        sNp = "73753543"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z115-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z120-C00-C2.vbs")
    ...
    elseif sPartNumber == "2098700189" then
        sRev = "REV A1"
        sNp = "73755126"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-B2.vbs")
    elseif sPartNumber == "2098700245" then
        sRev = "REV A"
        sNp = "73756631"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW01-000-C.vbs")
    elseif sPartNumber == "2098700256" then
        sRev = "REV A"
        sNp = "74756219"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW17-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-D.vbs")
    elseif sPartNumber == "2098700289" then
        sRev = "REV A"
        sNp = "74750754"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-C.vbs")
    elseif sPartNumber == "2098700290" then
        sRev = "REV A"
        sNp = "74750649"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-C00-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-C00-C.vbs")
    elseif sPartNumber == "2098700293" then
        sRev = "REV A2"
        sNp = "74750789"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z117-C01-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-D.vbs")
    ...
    elseif sPartNumber == "2098700302" then
        sRev = "REV A1"
        sNp = "74750416"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-D.vbs")
    ...
    elseif sPartNumber == "2098700305" then
        ...
        sNp = "74751005"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-L.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-C00-L.vbs")
    ...
    elseif sPartNumber == "2098700309" then
        sRev = "REV A2"
        sNp = "74750427"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-A.vbs")
    ...
    elseif sPartNumber == "2098700355" then
        sRev = "REV A1"
        sNp = "74751591"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z120-C00-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z120-C00-C-2.vbs")
    ...
    elseif sPartNumber == "2098700357" then
        sRev = "REV A"
        sNp = "74751593"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-K.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-C.vbs")
    ...
    elseif sPartNumber == "2098700371" then
        ...
        sNp = "74752798"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-L.vbs")
    ...
    elseif sPartNumber == "2098700429" then
        sRev = "REV A"
        sNp = "73756690"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-C.vbs")
    elseif sPartNumber == "2098700432" then
        sRev = "REV A"
        sNp = "74756216" 
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-F.vbs")
    ...
    elseif sPartNumber == "2098700437" then
        sRev = "REV A"
        sNp = "74756195"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z115-000-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-C.vbs")
    ...
    elseif sPartNumber == "2098706010" then
        sRev = "REV A"
        sNp = "09923935"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-B-1.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-B-2.vbs")
    ...
    elseif sPartNumber == "2098706085" then
        ...
        sNp = "74757303"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-L.vbs")
    elseif sPartNumber == "2098706086" then
        sRev = "REV A"
        sNp = "74757261"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-E.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ025-000-F.vbs")

    elseif sPartNumber == "2098706087" then
        sRev = "REV A"
        sNp = "74757252"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-E.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW17-000-C.vbs")
    elseif sPartNumber == "2098706088" then
        sRev = "REV A"
        sNp = "74757251"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-E.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ005-000-F.vbs")                
    ...
    elseif sPartNumber == "2099700057" then
        ...
        sNp = "74756921"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-L.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-L-2.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-L.vbs")
	    run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-A.vbs")
    ...
    elseif sPartNumber == "2099700059" then
        ...
        sNp = "74756653"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-L.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z113-000-L2.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z118-C00-L.vbs")
	    run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-A.vbs")
    elseif sPartNumber == "2154140243" then
        sRev = "REV B"
        sNp = "74752567"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\2291859-1.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
    ...
    elseif sPartNumber == "2154140289" then
        sRev = "REV A"
        sNp = "74754419"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\1-2291859-2.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
    ...
    elseif sPartNumber == "2154140294" then
        ...
        sNp = "74754538"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\2291859-1.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z232-000-C.vbs")
    ...
    elseif sPartNumber == "2154140349" then
        sRev = "REV A"
        sNp = "74756611"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z231-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z232-000-A.vbs")
    elseif sPartNumber == "2154140596" then
        sRev = "REV A"
        sNp = "74754728"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-C00-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-C00-A2.vbs")
    elseif sPartNumber == "2154150035" then
        sRev = "REV A1"
        sNp = "73754988"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ010-C00-B.vbs")
    elseif sPartNumber == "2154150089" then
        sRev = "REV A1"
        sNp = "E34806300"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ040-C00-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-A.vbs")
    elseif sPartNumber == "2154150215" then
        sRev = "REV A1"
        sNp = "E34806600"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ040-C00-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-B.vbs")
    elseif sPartNumber == "2154150250" then
        sRev = "REV A1"
        sNp = "74751487"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMK12A-102Z5.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMS11A-102Z5.vbs")
    elseif sPartNumber == "2154150337" then
        sRev = "REV A"
        sNp = "E35793800"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW29-000-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-B.vbs")
    ...
    elseif sPartNumber == "2154150588" then
        ...
        sNp = "E40941000"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ010-C00-C.vbs")
    ...
    elseif sPartNumber == "2154150943" then
        sRev = "REV B"
        sNp = "74756301"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW17-000-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-B.vbs")
    -------------------------------------------------------------------------------------------------------------
    -------------------------------------------------------- Inicia bloque FORD
    -------------------------------------------------------------------------------------------------------------
    elseif sPartNumber == "2154160029" then
        ...
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-C00-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-B.vbs")
        
    elseif sPartNumber == "2154160030" then
        sPartNumber = "SJ8T-18812-EB"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-C00-B.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-A.vbs")
    ...
    elseif sPartNumber == "2154160032" then
        ...
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z176-C01-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z114-000-A.vbs")
    elseif sPartNumber == "2154160034" then
        sPartNumber = "SJ8T-14F662-JA"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z163-003-F.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59z178-000.vbs")
    ...
    elseif sPartNumber == "2154170049" then
        ...
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ040-C00-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ032-C00-C.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-B.vbs")
    elseif sPartNumber == "2154170050" then
        sPartNumber = "SJ8T-19A397-EB"
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ040-C00-D.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZ040-C00-E.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\59Z153-000-K.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-A.vbs")
        run_vbs_hidden(BASE_VBS_PATH..sTester.."\\AMZW25-000-B.vbs")
...
-- ===============================================================
-- Helper: ejecuta comando y guarda log SOLO si hay error
-- ===============================================================
local function safe_execute(cmd)
    local ok, why, code = os.execute(cmd)
    if not ok or (type(ok) == "number" and ok ~= 0) then
        local logPath = "C:\\Users\\Public\\Documents\\Cirris\\printer\\exec.log"
        local f = io.open(logPath, "a")
        if f then
            f:write(string.format(
                "[%s] Command failed:\n%s\nReason: %s | Code: %s\n\n",
                os.date("%Y-%m-%d %H:%M:%S"),
                cmd, tostring(why), tostring(code)
            ))
            f:close()
        end
    end
...
-- ===============================================================
-- Función principal para imprimir PRN en EZWriter
-- ===============================================================
-- ===== Reemplazo: impresión con PowerShell, sin ventanas, con retry y log solo si falla =====
local function safe_log_error(line)
  local logPath = "C:\\Users\\Public\\Documents\\Cirris\\printer\\exec.log"
  local f = io.open(logPath, "a")
  if f then
...
-- Requiere: _ensure_dir, WriteStringToFile, copy_prn_hidden
...
function PrintRAWOnEZW(sSendToPrinterInput, sGetToPrinterHere)
  ...
  _ensure_dir(sSendToPrinterPath)
  ...
  -- Enviar PRN sin ventanas (sin cmd/copy)
